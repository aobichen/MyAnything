...
namespace Anything.Models
{
    ...
    public class ApplicationForUserManager : UserManager<ApplicationUser, int>
    {
        public ApplicationForUserManager(IUserStore<ApplicationUser, int> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationForUserManager(new UserForStore(context.Get<ApplicationForUserDbContext>()));
            ...
            manager.EmailService = new EmailServiceForUser();
    ...
    public class ApplicationRoleForManager : RoleManager<Role, int>
    {
        public ApplicationRoleForManager(IRoleStore<Role, int> roleStore)
            : base(roleStore)
        {
    ...
    public class EmailServiceForUser : IIdentityMessageService
    {
    ...
    public class ApplicationDbInitializerForUser : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
